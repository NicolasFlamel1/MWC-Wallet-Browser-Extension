...
chrome["runtime"]["onMessage"].addListener(function(request, sender, sendResponse) {
	...
	if(sender["id"] === chrome["runtime"]["id"] && typeof request === "object" && request !== null && "Wallet Type" in request === true && "Network Type" in request === true && "Request" in request === true && "Index" in request === true) {
				...
				return chrome["windows"].get(windowId["Window ID"]).then(function(window) {
					...
					// Otherwise
						...
						return chrome["windows"].create({
							...
							// URL
							"url": chrome["runtime"].getURL("./index.html") + URL_QUERY_STRING_SEPARATOR + encodeURIComponent("Is Popup").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent("True").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Override Wallet Type").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent(walletType).replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Override Network Type").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent(networkType).replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Request").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent("Start Transaction").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Recipient Address").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent(recipientAddress).replace(/%20/ug, "+") + ((amount !== NO_TRANSACTION_AMOUNT) ? URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Amount").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent(amount).replace(/%20/ug, "+") : "") + ((message !== NO_TRANSACTION_MESSAGE) ? URL_QUERY_STRING_PARAMETER_SEPARATOR + encodeURIComponent("Message").replace(/%20/ug, "+") + URL_QUERY_STRING_PARAMETER_VALUE_SEPARATOR + encodeURIComponent(message).replace(/%20/ug, "+") : ""),
